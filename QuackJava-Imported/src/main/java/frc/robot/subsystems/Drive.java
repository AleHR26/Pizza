...
public class Drive {
    private CANSparkMax L1 = new CANSparkMax(3, MotorType.kBrushless);
    private CANSparkMax L2 = new CANSparkMax(4, MotorType.kBrushless);
    private CANSparkMax R1 = new CANSparkMax(1, MotorType.kBrushless);
    private CANSparkMax R2 = new CANSparkMax(2, MotorType.kBrushless);
